...
.nextRow:           ; reset varIcol and mouse + varIcol
                    xor     ax, ax
                    mov     [var_wIcol], ax
                    mov     ax, [wMouseX]
                    mov     [var_wIcolScreen], ax
...
.nextRow:           ; reset var_wIcol and var_wIcolScreen
                    xor     ax, ax
                    mov     [var_wIcol], ax
                    mov     ax, [wMouseX]
                    mov     [var_wIcolScreen], ax
...
rgbyCursorShape:    db      255,   0,   0,   0,   0,
.r2:                db      255, 255,   0,   0,   0,
                    db      255, 255, 255,   0,   0,
